...
class EnsembleRetrieverChain(BaseChain):
    ...
    def create_retriever(self):
        ...
        similarity_retriever_chain.create_retriever(search_k=3)
        ...
        mmr_retriever_chain.create_retriever(
            vector_db=faiss_db, search_k=3, lambda_mult=0.9
        )
        ...
        bm25_retriever_chain.create_retriever(
            embedded_docs=(processed_docs + processed_manpages), search_k=3
        )
