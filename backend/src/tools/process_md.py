...
def chunk_markdown(embeddings_model_name: str , files_path: str, chunk_size: int) -> list[LangchainDocument]:
    ...
    for doc in documents:
        new_metadata = {"url":src_dict[doc.metadata['source']],"source":doc.metadata['source']}
        documents_knowledge_base.append(LangchainDocument(page_content=doc.page_content, metadata=new_metadata))
