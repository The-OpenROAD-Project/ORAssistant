...
class TestProcessJSON:
    ...
    def test_parse_json_basic(self):
        ...
        assert (
            "User2: You can install OpenROAD using Docker or building from source."
            in result
        )
    ...
    def test_parse_json_user_only(self):
        ...
        json_object = {
            "messages": [{"user": "First question"}, {"user": "Second question"}]
        }
    ...
    def test_parse_json_empty_messages(self):
        ...
        assert (
            result
            == "Infer knowledge from this conversation and use it to answer the given question.\n\t"
        )
    ...
    def test_generate_knowledge_base_multiple_files(self):
        ...
        json_data1 = [
            {"messages": [{"user": "File 1 question"}, {"assistant": "File 1 answer"}]}
        ]
        json_data2 = [
            {"messages": [{"user": "File 2 question"}, {"assistant": "File 2 answer"}]}
        ]
