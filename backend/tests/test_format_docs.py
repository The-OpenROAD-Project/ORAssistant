...
class TestFormatDocs:
    ...
    def test_format_docs_basic(self):
        ...
        docs = [
            Document(page_content="Content 1", metadata={"source": "test1.md"}),
            Document(page_content="Content 2", metadata={"source": "test2.md"}),
        ]
    ...
    def test_format_docs_with_man1_source(self):
        ...
        _, doc_srcs, _, doc_texts = format_docs(docs)
    ...
    def test_format_docs_with_urls(self):
        ...
        docs = [
            Document(
                ...
                metadata={"source": "web.md", "url": "https://example.com"},
            ),
            Document(
                page_content="More web content",
                metadata={"source": "web2.md", "url": "https://example2.com"},
            ),
        ]

        _, doc_srcs, doc_urls, _ = format_docs(docs)
    ...
    def test_format_docs_mixed_sources(self):
        ...
        docs = [
            Document(page_content="Regular content", metadata={"source": "regular.md"}),
            Document(
        ...
        _, _, _, doc_texts = format_docs(docs)
    ...
    def test_format_docs_no_source_metadata(self):
        ...
        docs = [
            Document(
                page_content="Content without source", metadata={"other": "metadata"}
            )
        ]
    ...
    def test_format_docs_partial_metadata(self):
        ...
        docs = [
            Document(page_content="With source", metadata={"source": "test.md"}),
            Document(page_content="Without source", metadata={"other": "data"}),
            Document(
                page_content="With source and URL",
                metadata={"source": "test2.md", "url": "https://example.com"},
            ),
        ]
