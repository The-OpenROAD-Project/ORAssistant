...
class TestChunkDocuments:
    ...
    def test_chunk_documents_large_text(self):
        ...
        docs = [Document(page_content=large_content, metadata={"source": "large.md"})]
    ...
    def test_chunk_documents_multiple_docs(self):
        ...
        docs = [
            Document(
                page_content="First document content.", metadata={"source": "doc1.md"}
            ),
            Document(
    ...
    def test_chunk_documents_deduplication(self):
        ...
        docs = [
            Document(page_content=duplicate_content, metadata={"source": "doc1.md"}),
            Document(page_content=duplicate_content, metadata={"source": "doc2.md"}),
        ]
    ...
    def test_chunk_documents_start_index_added(self):
        ...
        docs = [Document(page_content=large_content, metadata={"source": "test.md"})]
    ...
    def test_chunk_overlap_calculation(self):
        ...
        chunk_size = 100
        _ = int(chunk_size / 10)  # Should be 10
    ...
    def test_chunk_documents_real_world_scenario(self):
        ...
        docs = [
            Document(
                ...
                metadata={"source": "installation.md", "category": "documentation"},
            )
        ]
